...
describe('Activity', () => {
  ...
  beforeEach(() => {
    ...
    user2 = sampleUsersData[1];
    user3 = sampleUsersData[2];
  ...
  it('should return all days that a given user exceeded their step goal', () => {
    ...
    expect(activity.getDaysGoalExceeded()).to.eql(['2019/06/21']);
  });
...
describe('Friend Activity', () => {
  ...
  it('should get a users ranked friendslist activity for a chosen week', () => {
    console.log(activity.getFriendsAverageStepsForWeek(user4, '2019/06/15', userRepo))
